...
- (void)initUI{
    ...
    if (!_headerImage) {
        _headerImage = [[UIImageView alloc] initWithFrame:CGRectMake(DYWidth-40, 10, 30, 30)];
        _headerImage.image = [UIImage imageNamed:@"icon2"];
    ...
    if (!_bubbleImage) {
        _bubbleImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"chat_send"] resizableImageWithCapInsets:UIEdgeInsetsMake(40, 40, 40, 40)]];
